...
# ===== 設定 =====
adding_list = ["TestImagesForPrograms/06.jpg","TestImagesForPrograms/22.jpg","TestImagesForPrograms/39.jpg"]
...
for element in adding_list:
    ...
    # ===== 手動取樣 =====
    #face_points = collect_points(10, f"Click 10 FACE points: {element}", processed_bgr)
    nonface_points = collect_points(5, f"Click 5 NON-FACE points: {element}", processed_bgr)

    #ace_records = extract_features(face_points, processed_rgb, 1)
