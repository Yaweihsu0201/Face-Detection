...
#adding_list = ["TestImagesForPrograms/16.jpg", "TestImagesForPrograms/15.jpg", "TestImagesForPrograms/20.jpg", "TestImagesForPrograms/20.jpg"]
adding_list = ["TestImagesForPrograms/14.jpg"]
...
for element in adding_list:
    ...
    #face_points = collect_points(5, "Click 5 FACE points", sample)
    nonface_points = collect_points(3, "Click 3 NON-FACE points", sample)
